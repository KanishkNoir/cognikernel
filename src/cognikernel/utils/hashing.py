...
Lives in utils (a dependency-free base) so both the extraction stage and the
delta merge can compute identity hashes without importing across each other —
the extraction<->delta layering cycle the architecture audit surfaced.
"""
